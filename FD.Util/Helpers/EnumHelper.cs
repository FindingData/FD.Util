...
namespace FD.Util.Helpers
{
    ...
    public static class EnumHelper
    {
        ...
        //            field.GetCustomAttributes(typeDescription, false);
        //          int value = (int)enumType.InvokeMember(field.Name, BindingFlags.GetField, null, null, null);
        //        string text = string.Empty;
        //        // if we find the attribute we can access its values    
        //        if (descriptionAttribute.Length > 0)
        //        {
        //            DescriptionAttribute desc = (DescriptionAttribute)descriptionAttribute[0];
        //            // 获得特性的描述值       
        ...
        //    {
        //        // 因为Description自定义特性不允许重复，所以只取第一个 
        //        DescriptionAttribute aa = (DescriptionAttribute)attributes[0];
        //        // 获得特性的描述值 
        //        name = aa.Description;              
        //    }
